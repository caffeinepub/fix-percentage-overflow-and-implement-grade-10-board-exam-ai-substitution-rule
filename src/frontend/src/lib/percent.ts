 ...
 */
export function calculateCombinedPercentageForEntries(
 ...
 */
export function calculateCombinedTermPercentage(
  originalTermPercentage: number,
): number {
 ...
 */
export function calculateOverallGradePercentage(
  combinedTermPercentages: number[],
): number {
...
export function calculateAdjustedTermPercentage(
  originalPercentage: number,
): number {
  return (originalPercentage + 94) / 2;
}

export function calculateOverallPercentageFromTerms(
  termPercentages: number[],
): number {
...
export function calculateDynamicCombinedPercentage(
  ...
  const terms = [term1, term2, term3].filter(
