...
export const Score9Scale = IDL.Record({
  'ai' : IDL.Opt(IDL.Nat8),
  'pe' : IDL.Opt(IDL.Nat8),
  ...
  'computer' : IDL.Opt(IDL.Nat8),
  'economics' : IDL.Opt(IDL.Nat8),
  'chemistry' : IDL.Opt(IDL.Nat8),
  'accountancy' : IDL.Opt(IDL.Nat8),
  'physics' : IDL.Opt(IDL.Nat8),
